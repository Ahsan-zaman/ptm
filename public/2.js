    ...
    validate: function validate() {
      if (this.active == 0) {
        ...
        if (sMySup.length || sMPSup.length || sInviteSup.length) {
          ...
          this.summarySuppliers = [].concat(_toConsumableArray(sMySup), _toConsumableArray(sMPSup), _toConsumableArray(sInviteSup));
        } else {
          EventBus.$emit('alert', {
        ...
        var data = {
          ...
          suppliers: [].concat(_toConsumableArray(this.mySuppliers.filter(function (s) {
            return s.checked;
          }).map(function (s) {
            return s.id;
          })), _toConsumableArray(this.MPSuppliers.filter(function (s) {
            return s.checked;
          }).map(function (s) {
            return s.id;
          }))),
                            ...
                            _c("div", { staticClass: "row" }, [
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _vm._v(" "),
                                  _vm._l(_vm.summarySuppliers, function(s, i) {
                                    return _c(
                                      "div",
                                      {
                                        key: s.id,
