        ...
        <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-lg-9">
                    <div class="border shadow-sm rounded p-1">
                        <div class="row g-0 border-bottom">
                            <div class="col-12 col-md-9 d-flex align-items-center p-2">
                                <div class="row">
                                    <div class="col-4 col-md-3">
                                        <div class="mx-auto" :style="`background:url('/assets/1.png') center/cover no-repeat`" style="width:90px;height:90px"></div>
                                    </div>
                                    <div class="col-8 col-md-9">
                                        <h3 class="link-primary">Tender/Project name example placeholder ...</h3>
                                        <span class="font-weight-bold">Company Name : Saudi Procurement Service</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-3 border-left">
                                <div class="row g-0">
                                    <div class="col-6 col-md-12 text-center text-md-left lh-sm p-2">Tender Number <br> 098 – ع 68</div>
                                    <div class="col-6 col-md-12 text-center text-md-left lh-sm p-2">Price <br> 14,000 ر.س.</div>
                                </div>
                            </div>
                        </div>
                        <div class="row g-0">
