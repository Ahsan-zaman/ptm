...
export default new VueRouter({
    ...
    routes:[
        ...
        {path:'/public-tenders',name : 'PublicTenders',component: () => import("../components/PublicTenders.vue")},
        {path:'/public-tenders/:id',name : 'PublicTender',component: () => import("../components/TenderView.vue")},
